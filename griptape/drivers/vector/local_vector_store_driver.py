...
class LocalVectorStoreDriver(BaseVectorStoreDriver):
    ...
    def query(
        ...
        **kwargs,
        ...
        result = [
            BaseVectorStoreDriver.QueryResult(vector=er[0].vector, score=er[1], meta=er[0].meta)
        ...
        if include_vectors:
            ...
            return [BaseVectorStoreDriver.QueryResult([], r.score, r.meta, r.namespace) for r in result]
