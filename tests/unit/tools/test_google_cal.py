...
class TestGoogleCalClient:
    def test_get_upcoming_events(self):
        ...
        assert (
            "error retrieving calendar events"
            in GoogleCalendarClient(service_account_credentials={}).get_upcoming_events({"values": value}).value
        )
    ...
    def test_create_event(self):
        ...
        assert (
            ...
            in GoogleCalendarClient(service_account_credentials={}).create_event({"values": value}).value
        )
