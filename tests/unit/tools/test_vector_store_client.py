...
class TestVectorStoreClient:
    ...
    def mock_try_runt(self, mocker):
        ...
        mocker.patch("griptape.drivers.OpenAiEmbeddingDriver.embed_chunk", return_value=[0, 1])

    def test_search(self):
        tool = VectorStoreClient(description="Test", query_engine=VectorQueryEngine())
